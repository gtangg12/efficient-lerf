...
def mask_nms(masks, scores, iou_thr=0.7, score_thr=0.1, inner_thr=0.2, **kwargs):
    ...
    # iou_matrix_clone = iou_matrix.clone()
    # inner_iou_matrix_clone = inner_iou_matrix.clone()
    ...
    # assert torch.allclose(iou_matrix, iou_matrix_clone, atol=1e-3), "iou_matrix computation error"
    # assert torch.allclose(inner_iou_matrix, inner_iou_matrix_clone, atol=1e-3), "inner_iou_matrix computation error"
    # exit()
